...
{
    private const string JSON_PATH = "Assets/_Project/Data/ItemsResources/events_story2.json";
    ...
    private const string EVENTDATA_DIR_PATH = "Assets/_Project/Data/Events/Story2";
