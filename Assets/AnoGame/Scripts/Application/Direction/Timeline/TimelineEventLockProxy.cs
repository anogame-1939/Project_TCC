...
namespace AnoGame.Application.Direction.Timeline
{
    ...
    public sealed class TimelineEventLockProxy : MonoBehaviour
    {
        ...
        [Inject]
        public void Construct(EventLockControl playerCtrl /* GameScope で登録済み */)
        {
        ...
        public void LookKeep() => _playerCtrl.LookKeep();
        public void LookFaceMove() => _playerCtrl.LookFaceMove();
        public void LookAt(Transform t) => _playerCtrl.LookAt(t);
