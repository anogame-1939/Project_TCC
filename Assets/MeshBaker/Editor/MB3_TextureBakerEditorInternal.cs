...
namespace DigitalOpus.MB.MBEditor
{
    public class MB3_TextureBakerEditorInternal
    {
        ...
        public class MultiMatSubmeshInfo
        {
            ...
            public GameObjectFilterInfo.TransparentOrOpaque stdBlendMode = GameObjectFilterInfo.TransparentOrOpaque.NotApplicable;
            ...
            public MultiMatSubmeshInfo(Shader s, Material m)
            {
                ...
                {
                    stdBlendMode = (GameObjectFilterInfo.TransparentOrOpaque)m.GetFloat("_Mode");
                }
                else
                {
                    stdBlendMode = GameObjectFilterInfo.TransparentOrOpaque.NotApplicable;
                }
            }
