    ...
    public class TextureBlenderURPLit : TextureBlender
    {
        ...
        public bool DoesShaderNameMatch(string shaderName)
		{
			return  shaderName.Equals("Universal Render Pipeline/Lit") ||
                    ...
                    shaderName.Equals("Universal Render Pipeline/Unlit") ||
                    shaderName.Equals("Universal Render Pipeline/Complex Lit") ||
                    shaderName.Equals("Universal Render Pipeline/Particles/Lit") ||
                    shaderName.Equals("Universal Render Pipeline/Particles/Unlit") ||
                    shaderName.Equals("Universal Render Pipeline/Particles/Simple Lit");
		}
        ...
        public void SetNonTexturePropertyValuesOnResultMaterial(Material resultMaterial)
        {
            ...
            if (m_workflowMode == WorkflowMode.specular)
            {
                if (resultMaterial.HasProperty("_SpecGlossMap"))
                {
            ...
            if (m_workflowMode == WorkflowMode.metallic)
            {
                if (resultMaterial.HasProperty("_MetallicGlossMap"))
                {
