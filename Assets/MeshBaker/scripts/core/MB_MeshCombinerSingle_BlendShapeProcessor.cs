        ...
        internal class MB_MeshCombinerSingle_BlendShapeProcessor
        {
                ...
                for (int bsIdx = 0; bsIdx < nblendShapes.Length; bsIdx++)
                {
                    ...
                    if (dgo != null)
                    {
                        ...
                        for (int frmIdx = 0; frmIdx < blendShape.frames.Length; frmIdx++)
                        {
                            ...
                            MBVersion.AddBlendShapeFrame(_mesh, _ConvertBlendShapeNameToOutputName(blendShape.name) + blendShape.gameObject.GetInstanceID(), frame.frameWeight, targVerts, targNorms, targTans);
            ...
            public void CopyBlendShapesForNewMeshIfNecessary(ref int targBlendShapeIdx, MB_DynamicGameObject dgo, Mesh mesh, IMeshChannelsCacheTaggingInterface meshChannelCache)
            {
                if (combiner.settings.doBlendShapes)
                {
                    ...
                    MBBlendShape[] blendShapesFromMesh = meshChannelCache.GetBlendShapes(mesh, dgo.gameObject.GetInstanceID(), dgo.gameObject);
            ...
            /// <summary>
            /// The source blend shape may have parts that should be stripped away. Some users had meshes like:
            /// 
            ///   TongueSkinnedMesh
            ///     tongue.frown
            ///     tongue.smile
            ...
            ///     ...
            ///     
            /// The wanted the combined mesh to have blend shapes:
            ///   CombinedMesh
            ///     frown
            ///     smile
            ///     
            /// Use this method to strip away the unused parts. It can be modified to use a different naming convention.
            /// </summary>
